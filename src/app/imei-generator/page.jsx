...
const IMEIGenerator = () => {
  ...
  const generateIMEI = () => {
    ...
    try {
      // Generate first 14 digits (TAC + Serial Number)
      let imei = '';
      for (let i = 0; i < 14; i++) {
      ...
      setError('An error occurred while generating the IMEI. Please try again.');
    }
  };
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 shadow-lg">
            ...
            {result !== null && (
              <div className="text-center">
                <h2 className="text-2xl font-semibold mb-2">Your IMEI</h2>
            ...
            <div className="mt-8 text-sm text-[#C7D3D4]/60">
              <p className="text-center">
                ...
                The generated IMEIs include a valid Luhn checksum digit.
                These are for demonstration purposes only and should not be used for actual device identification.
              </p>
            </div>
          </div>
        </div>

...
const AddressGenerator = () => {
  ...
  const generateAddress = () => {
    ...
    if (!includeStreet && !includeCity && !includeState && !includeZipCode && !includeCountry) {
    ...
    if (includeCountry) {
      address.push(countries[Math.floor(Math.random() * countries.length)]);
    }
    ...
    <div className="min-h-screen bg-[#603F83] text-[#C7D3D4]">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-[#C7D3D4]/20">
          <h1 className="text-3xl font-bold mb-6">Address Generator</h1>
          <p className="mb-8 text-[#C7D3D4]/80">
            Generate random addresses with customizable components. Select which parts of the address you want to include.
          </p>

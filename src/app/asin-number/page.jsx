...
const ASINGenerator = () => {
  ...
  const generateASIN = () => {
    ...
    try {
      ...
      // ASINs can contain letters and numbers
      const characters = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789';
      let asin = '';
      
      for (let i = 0; i < 10; i++) {
        const randomIndex = Math.floor(Math.random() * characters.length);
        asin += characters[randomIndex];
      }
      
      setResult(asin);
    } catch (err) {
      setError('An error occurred while generating the ASIN. Please try again.');
    }
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-[#C7D3D4]/80">
              Generate valid ASIN numbers for Amazon products
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 shadow-lg">
            ...
            {result !== null && (
              <div className="text-center">
                <h2 className="text-2xl font-semibold mb-2">Your ASIN</h2>
            ...
            <div className="mt-8 text-sm text-[#C7D3D4]/60">
              <p className="text-center">
                Note: This tool generates random 10-character ASIN numbers that follow the standard format.
                ASINs can contain both letters and numbers.
                These are for demonstration purposes only and should not be used for actual Amazon product listings.
              </p>
            </div>
          </div>
        </div>
